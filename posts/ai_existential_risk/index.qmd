...
It's an interesting interview, and he comes off as well-informed and thoughtful. Having said that, were I holding valuable private placement shares at Anthropic, I wouldn't be happy about their new hire arguing that Mythos may be pushing the world to the "already there" point of doing "enormous harm to the economy and to people." Coupled with his toy model showing how the implied tradeoff from classical economic models might allow a good deal of risk seeking over extinction with standard utility functions, it didn't make a ton of sense to me.
